  ...
  Future<void> _loadMessages() async {
    ...
    if (employerId != null) {
      final fetchedMessages =
          await messageService.getListMessageByEmploerId(employerId);
      // Tải dữ liệu user và kết hợp với messages
      List<Map<String, dynamic>> combinedData = [];
      for (var message in fetchedMessages) {
        final user = await userService.getUserById(message.applicantId);
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) => ChatPage(
                                  ...
                                  apllicantName: user.fullName,
                                  filePath: user.fileCvUrl,
                                  user: user,
                                )),
                      );
                    },
