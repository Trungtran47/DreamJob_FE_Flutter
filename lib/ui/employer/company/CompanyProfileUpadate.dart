...
class _CompanyProfileState extends State<CompanyProfileUpdate> {
  File? _image;
  ...
  Future<void> _saveOrUpdateCompany() async {
    if (_formKey.currentState!.validate()) {
      try {
        ...
        await widget.companyService
            .updateCompany(widget.companyId, widget.userId, company, _image);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Chỉnh sửa tin công ty'),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Vui lòng nhập loại hình công ty';
                    }
                    return null;
                  },
                ),
                ...
                SizedBox(height: 20),
                ElevatedButton(
                  onPressed: _saveOrUpdateCompany,
                  child: Text('Lưu'),
                ),
              ],
            ),
