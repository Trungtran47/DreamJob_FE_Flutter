...
import 'package:dacn2/ui/admin/company/widgetCompanyDetail/AdminCompanyBlog.dart';
import 'package:dacn2/ui/admin/company/widgetCompanyDetail/AdminCompanyPost.dart';
...
class CompanyDetaiilPage extends StatefulWidget {
  final Company company;

  CompanyDetaiilPage({required this.company}); // Constructor

  @override
  _CompanyDetailPageState createState() => _CompanyDetailPageState();
}

class _CompanyDetailPageState extends State<CompanyDetaiilPage> {
  ...
  void initState() {
    ...
    _pages = [
      AdminCompanyPostsPage(futurePosts: futurePosts),
      AdminCompanyBlogPage(futureBlogs: futureBlogs),
    ];
  }
